...
End-to-end price intelligence system that scrapes data on electronics pricing/sales, predicts optimal pricing strategies using ML models (XGBoost, Random Forest), and validates recommendations through A/B testing. Delivers actionable insights via an interactive dashboard!
...
- Collected some data on Amazon products using octaprice, cleaned the dataset to only include electronics products
